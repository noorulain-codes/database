...
('root', '[{\"db\":\"restaurant_db\",\"table\":\"customers\"},{\"db\":\"restaurant_db\",\"table\":\"menu_items\"}]');
...
('root', '2025-05-27 09:24:02', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
...
(2, 'John Doe', 'john.doe@email.com', '555-0101', '2025-05-26 11:43:59'),
...
(4, 'Caesar Salad', 'Fresh romaine, croutons, and Caesar dressing', 8.50, 'Appetizer', 'salad.jpg', '2025-05-26 11:43:58'),
(5, 'Chocolate Lava Cake', 'Warm chocolate cake with a molten center', 6.99, 'Dessert', 'cake.jpg', '2025-05-26 11:43:58'),
...
CREATE TABLE `staff` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
  `role` enum('Chef','Waiter','Manager','Host') NOT NULL,
  `email` varchar(100) NOT NULL,
  `phone` varchar(20) DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
